...
class PublicIngredientsApiTests(TestCase):
    ...
    def test_login_required(self):
        """Ensure login required for Ingredients API"""
...
class PrivateIngredientsApiTests(TestCase):
    ...
    def setUp(self):
        self.client = APIClient()
        self.user = get_user_model().objects.create_user("testing@test.com", "testpass")
    ...
    def test_retrieve_ingredient_list_user(self):
        """Retrive ingredients only for current user"""
    ...
    def test_create_ingredient_invalid(self):
        """Create invalid ingrediten fails"""
        payload = {"name": ""}
